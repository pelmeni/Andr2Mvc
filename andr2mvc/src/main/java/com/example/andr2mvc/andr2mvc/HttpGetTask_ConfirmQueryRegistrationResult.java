...
public class HttpGetTask_ConfirmQueryRegistrationResult extends AsyncTask {

    private final Lock lock = new ReentrantLock();

    AsyncTaskCompleteListener callback;

    public HttpGetTask_ConfirmQueryRegistrationResult(AsyncTaskCompleteListener callback)
    {

...
public class IOUtil {
    ...
    public static  void StoreImage(Bitmap image, String dirName, String fileName) {
        String TAG="tag";
        File pictureFile = GetOutputMediaFile(dirName, fileName);
        if (pictureFile == null) {
            Log.d(TAG,
    ...
    public static  File GetOutputMediaFile(String dirName, String fileName){

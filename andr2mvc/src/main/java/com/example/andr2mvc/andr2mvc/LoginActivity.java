...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneNumberView = (EditText) findViewById(R.id.phoneTextView);

        mPasswordView = (EditText) findViewById(R.id.userCodeTextView);

        mNickNameView = (EditText) findViewById(R.id.nickNameTextView);
...
//        });
        ...
        Button mRegButton = (Button) findViewById(R.id.RegButton);
...
//        private final String mSimNo;
//
//        UserRegTask(String email, String phone, String nickname, String simno) {
//            mEmail = email;
//            mPhone = phone;
//            mNickname=nickname;
//            mSimNo=simno;
...
//            nameValuePairs.add(new BasicNameValuePair("simno",mSimNo.toString()));
//            nameValuePairs.add(new BasicNameValuePair("operationType","1"));
//
//            AsyncTaskCompleteListener callback=new AsyncTaskCompleteListener() {
//                @Override
